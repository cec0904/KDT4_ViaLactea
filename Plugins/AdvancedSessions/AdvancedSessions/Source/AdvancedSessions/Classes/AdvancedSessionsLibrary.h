...
public:
		...
		UFUNCTION(BlueprintCallable, Category = "AdvancedSessions|Utility", meta = (WorldContext = "WorldContextObject"))
		static bool StartListenServer(UObject* WorldContextObject, int32 Port = 7777);
